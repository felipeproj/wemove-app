...
export const INITIAL_ITEMS: CreateItemPayload[] = [
  ...
  { amb: 'Cozinha', nome: 'Geladeira', cat: 'Essencial', pri: 'Alta', qtd: 1, preco_min: 1800, preco_max: 3500, obs: 'Prefira modelos de 260–330 L, largura máx 60 cm.' },
  ...
  { amb: 'Cozinha', nome: 'Micro-ondas', cat: 'Essencial', pri: 'Alta', qtd: 1, preco_min: 350, preco_max: 1000, obs: '20–32 L suficiente para casal.' },
  { amb: 'Cozinha', nome: 'Depurador / Coifa', cat: 'Essencial', pri: 'Alta', qtd: 1, preco_min: 400, preco_max: 1800, obs: 'Depurador recirculante dispensa duto.' },
  ...
  { amb: 'Cozinha', nome: 'Copos', cat: 'Essencial', pri: 'Alta', qtd: 1, preco_min: 40, preco_max: 180, obs: 'Kit com 6–8 unidades.' },
  { amb: 'Cozinha', nome: 'Pratos', cat: 'Essencial', pri: 'Alta', qtd: 1, preco_min: 60, preco_max: 300, obs: 'Jogo com 6–8 peças (raso, fundo e sobremesa).' },
  ...
  { amb: 'Quarto Casal', nome: 'Colchão', cat: 'Essencial', pri: 'Alta', qtd: 1, preco_min: 800, preco_max: 3000, obs: 'D33–D45, Queen 1,58×1,98 m.' },
  ...
  { amb: 'Escritório', nome: 'Mesa de escritório', cat: 'Essencial', pri: 'Alta', qtd: 1, preco_min: 500, preco_max: 2500, obs: 'Mesa em L ou duas mesas de 1,20 m para 2 pessoas.' },
  ...
  { amb: 'Escritório', nome: 'Monitores curvos (x2)', cat: 'Essencial', pri: 'Alta', qtd: 2, preco_min: 800, preco_max: 2500, obs: '27"–32". Verifique HDMI/DisplayPort.' },
  { amb: 'Escritório', nome: 'Estante / prateleiras', cat: 'Não Essencial', pri: 'Média', qtd: 1, preco_min: 200, preco_max: 800, obs: 'Para livros e organização.' },
  ...
  { amb: 'Área de Serviço', nome: 'Tanque de lavar', cat: 'Essencial', pri: 'Média', qtd: 1, preco_min: 150, preco_max: 500, obs: 'Verifique se já existe instalação.' },
  ...
  { amb: 'Banheiro / Lavabo', nome: 'Espelho / armário espelhado', cat: 'Essencial', pri: 'Alta', qtd: 2, preco_min: 100, preco_max: 500, obs: 'Para cada banheiro.' },
  { amb: 'Banheiro / Lavabo', nome: 'Suporte para papel higiênico', cat: 'Essencial', pri: 'Alta', qtd: 2, preco_min: 30, preco_max: 100, obs: 'Simples de parede.' },
  ...
  { amb: 'Geral / Tecnologia', nome: 'Aspirador de pó', cat: 'Essencial', pri: 'Média', qtd: 1, preco_min: 300, preco_max: 2000, obs: 'Aspirador sem fio ou robô.' },
  ...
  { amb: 'Geral / Tecnologia', nome: 'Cortinas ou persianas', cat: 'Essencial', pri: 'Alta', qtd: 4, preco_min: 150, preco_max: 800, obs: 'Blackout nos quartos melhora o sono.' },
  ...
  { amb: 'Geral / Tecnologia', nome: 'Parafusadeira elétrica', cat: 'Não Essencial', pri: 'Média', qtd: 1, preco_min: 150, preco_max: 600, obs: 'Parafusadeira/furadeira de impacto. Essencial para montar móveis.' },
]
